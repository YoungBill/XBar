...
fun FragmentActivity.statusBarTransparent(statusBarLight: Boolean) {
    when {
    ...
    setSystemUiFlagWithStatusBar(statusBarLight)
}

@RequiresApi(Build.VERSION_CODES.KITKAT)
fun FragmentActivity.navigationBarTransparent(navigationBarLight: Boolean) {
    when {
        Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q -> {
    ...
    setSystemUiFlagWithNavigationBar(navigationBarLight)
}

@RequiresApi(Build.VERSION_CODES.KITKAT)
internal fun FragmentActivity.setSystemUiFlagWithStatusBar(statusBarLight: Boolean) {
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) return
    window?.decorView?.systemUiVisibility = systemUiFlagWithStatusBar(statusBarLight)
}

@RequiresApi(Build.VERSION_CODES.KITKAT)
internal fun FragmentActivity.setSystemUiFlagWithNavigationBar(navigationBarLight: Boolean) {
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) return
